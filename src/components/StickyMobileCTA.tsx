  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      requestAnimationFrame(() => {
        ...
        if (scrolled !== isVisibleRef.current) {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-primary shadow-[0_-4px_20px_rgba(0,0,0,0.15)] animate-slide-up">
      <div className="flex items-center gap-3 p-3 safe-area-inset-bottom">
        ...
        <Link
          to="/get-quote"
          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-white text-primary font-body font-semibold text-sm transition-[transform] duration-200 active:scale-[0.98]"
        >
          Get Free Quote
        ...
        <a
          href="tel:6146120050"
          className="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-white/10 text-white transition-[background-color] duration-200 active:scale-[0.95]"
          aria-label="Call us"
        >
